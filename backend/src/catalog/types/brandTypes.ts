import { brands, brandTranslations } from "../../db/schema/catalog";
...
export type TBrandTranslation = InferSelectModel<typeof brandTranslations>;
export type TBrandTranslationInsert = InferInsertModel<typeof brandTranslations>;
...
export type TBrandUpdate = Partial<Omit<TBrandCreate, 'client_id'>> // client_id usually shouldn't be updated
