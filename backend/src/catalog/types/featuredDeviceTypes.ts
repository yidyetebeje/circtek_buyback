...
import { featuredDevices } from "../../db/schema/catalog";

// Type for inserting a new featured device (matches table structure, usually without id, createdAt, updatedAt)
export type NewFeaturedDevice = typeof featuredDevices.$inferInsert;
...
export type FeaturedDevice = typeof featuredDevices.$inferSelect & {
...
export const NewFeaturedDeviceSchema = t.Object({
  ...
  clientId: t.Optional(t.Numeric()), // Made optional; controller will use user.clientId if not provided by super-admin
