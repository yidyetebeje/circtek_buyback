import { modelSeries, modelSeriesTranslations } from "../../db/schema/catalog";
import { InferInsertModel, InferSelectModel } from "drizzle-orm";
import { t } from 'elysia';

// Base types inferred from schema
export type TModelSeries = InferSelectModel<typeof modelSeries>;
export type TModelSeriesInsert = InferInsertModel<typeof modelSeries>;
export type TModelSeriesTranslation = InferSelectModel<typeof modelSeriesTranslations>;
export type TModelSeriesTranslationInsert = InferInsertModel<typeof modelSeriesTranslations>;
...
export type TModelSeriesUpdate = Partial<Omit<TModelSeriesCreate, 'client_id'>> // client_id usually shouldn't be updated
