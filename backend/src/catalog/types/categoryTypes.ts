...
import { deviceCategories, deviceCategoryTranslations } from '../../db/schema/catalog';

// Base schemas generated from Drizzle tables
export const DeviceCategorySchema = createSelectSchema(deviceCategories);
export const DeviceCategoryTranslationSchema = createSelectSchema(deviceCategoryTranslations);

// Schema for creating a new category (omit auto-generated fields)
export const CategoryInsertSchema = createInsertSchema(deviceCategories);
...
export const CategoryTranslationInsertSchema = createInsertSchema(deviceCategoryTranslations);
...
export const CategoryWithTranslationsResponseSchema = t.Object({
  ...DeviceCategorySchema.properties,
  translations: t.Array(DeviceCategoryTranslationSchema)
});
...
// Schema for filtering categories by client_id
...
// Schema for category slug and client ID in URL parameters
...
export type TDeviceCategory = Static<typeof DeviceCategorySchema>;
