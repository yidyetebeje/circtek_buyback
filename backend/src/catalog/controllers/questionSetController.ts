...
export class QuestionSetController {
  ...
  async getAllQuestionSets(
    ...
    try {
      return await questionSetService.getAllQuestionSets(page, limit, orderBy, order, clientId, search);
    } catch (error) {
  ...
  async getQuestionSetByInternalName(internalName: string, clientId: number) {
    try {
      return await questionSetService.getQuestionSetByInternalName(internalName, clientId);
    } catch (error) {
      console.error(`Error in getQuestionSetByInternalName(${internalName}, ${clientId}):`, error);
      throw error;
    }
  }
  ...
  async createQuestionSet(data: TQuestionSetCreate, clientId: number) {
    try {
      const questionSet = await questionSetService.createQuestionSet(data, clientId);
      return {
        success: true,
        data: questionSet,
  ...
  async createQuestionSetWithQuestions(data: any, clientId: number) {
    try {
      const questionSet = await questionSetService.createQuestionSetWithQuestions(data, clientId);
      return {
        success: true,
        data: questionSet,
  ...
  async createQuestionSetWithQuestionsAndTranslations(data: any, clientId: number) {
    try {
      const questionSet = await questionSetService.createQuestionSetWithQuestionsAndTranslations(data, clientId);
      return {
        success: true,
        data: questionSet,
